  ...
  const adminSidebar = [
    {
      ...
      title: "Manage Order",
      src: <FaShoppingCart />,
      link: "/dashboard/admin/manage_orders",
    },
    {
      id: 1,
      title: "Add Product",
    ...
    },
    {
      ...
      src: <FaList />,
      link: "/dashboard/admin/manage_product",
    },
    {
      id: 3,
      title: "Manage Users",
    ...
    },
    {
      ...
      src: <MdCategory />,
      link: "/dashboard/admin/add_categories",
    },
    {
      id: 5,
      title: "Manage Categories",
      src: <BiSolidCategory />,
      link: "/dashboard/admin/manage_categories",
    },
    {
      id: 6,
      title: "Add Coupon",
      src: <FaTags />,
      link: "/dashboard/admin/add_coupon",
    },
    {
      id: 7,
      title: "Manage Coupon",
      src: <FaTags />,
      link: "/dashboard/admin/manage_coupon",
    },
    {
      id: 8,
      title: "Add New Blog",
      src: <FaBloggerB />,
      link: "/dashboard/admin/add_blog",
    },
    {
      id: 9,
      title: "Manage Blog",
      src: <SiBackstage />,
      link: "/dashboard/admin/manage_blog",
    },
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="p-5 pt-6 flex-shrink-0">
          <div
            className={`flex items-center mb-8 ${open ? "justify-between" : "flex-col gap-4"}`}
          >
          ...
          {meData && (
            <div
              className={` pb-6 border-b border-gray-700 transition-all duration-300 ${!open && "opacity-0 h-0 overflow-hidden mb-0 pb-0 border-0"}`}
            >
              <div className="flex items-center gap-3">
                ...
                <div
                  className={`min-w-0 flex-1 overflow-hidden ${!open && "w-0 opacity-0"}`}
                >
        ...
        {/* Footer Section */}
        <div
          className={`flex-shrink-0 p-5 border-t border-gray-700 bg-gray-900/50 backdrop-blur-sm transition-all duration-300 ${!open && "opacity-0 h-0 overflow-hidden p-0 border-0"}`}
        >
          <div className="flex items-center gap-3 text-gray-400 text-xs">
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse flex-shrink-0"></div>
            <span className={`overflow-hidden ${!open && "w-0 opacity-0"}`}>
              System Active
            </span>
          </div>
        </div>
