          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              {user ? (
                ...
                <Link
                  to="/login"
                  className="hidden lg:flex items-center gap-2 text-white bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-2.5 rounded-xl hover:from-indigo-500 hover:to-purple-500 transition-all font-semibold shadow-lg"
                >
                  <FaUser size={16} />
                  Login
                </Link>
                  ...
                  {!user && (
                    <li>
                      <Link
                        to="/login"
                        onClick={handleNav}
                        className="flex text-white items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 transition-all"
                      >
                        <FaUser size={16} />
                        Login
                      </Link>
